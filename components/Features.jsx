...
const features = [
  {
    name: "PHOTOGRAPHY",
    description:
      "Studio comes with elements made specifically for for photographers, including the client list, password protected pages, and the proofing gallery.",
  ...
  },
  {
    ...
    description:
      "It is a fully flexible theme. All elements, pages and every other aspect of your website can be effortlessly adapted to fit your specafic needs.",
    icon: LockClosedIcon,
  },
  {
    name: "FREE PLUGINS",
